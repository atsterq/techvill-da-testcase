...
def init_db(db_path, count):
    with sqlite3.connect(db_path) as conn:
        ...
        for employee_id in range(1, count + 1):
            ...
            y, m, d = rnd_profile.randint(1980, 2005), rnd_profile.randint(1, 12), rnd_profile.randint(1, 28)
            ...
            for dow in range(7):
                ...
                duty_data.append((duty_id, employee_id, dow, is_working, "09:00", "18:00"))
                duty_id += 1
...
def run_job():
    ...
    check_date = Config.TARGET_DATE if Config.TARGET_DATE is not None else datetime.date.today()
    ...
    with sqlite3.connect(Config.DB_NAME) as conn:
        ...
        cursor.execute(
            ...
            (check_date.isoformat(), check_date.weekday(), check_date.isoformat()),
        )
